...
class Interface:
    """
    Класс Интерфейс - абстракция программы для работы с деталями.
    Класс будет хранить в себе методы для работы с деталями.
    ...
    Поиск суммарного количества по всем категориям деталей;
